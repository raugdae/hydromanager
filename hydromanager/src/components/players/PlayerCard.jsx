...
function PlayerCard({ firstName, lastName, attendeeid, reloadParent}) {
  ...
  return (
    <><PlayerModal
      ...
      ><PlayerTicketForm attendeeId={attendeeid}/></PlayerModal>
    <div className="relative grid grid-cols-[2fr_2fr_2fr_6fr] content-start p-2 drop-shadow-xl">
      ...
      <div className="row-start-2 col-start-4 flex flex-row w-full p-4 gap-4 border-b-2 border-x-2 flex-wrap">
